...
echo "  bolt.diy:           https://build{0..5}.<your-domain> (team0 = organizer, always-on)"
echo "  DeepSeek Harness:   https://team{0..5}.<your-domain>   (team0 = organizer, always-on)"
echo "  Open WebUI:         https://analyze.<your-domain>"
echo
echo "Basic Auth credentials for every team live in app/team-credentials.txt"
echo "(generated by scripts/generate-team-auth.sh, gitignored, not pushed by"
echo "this script)."
